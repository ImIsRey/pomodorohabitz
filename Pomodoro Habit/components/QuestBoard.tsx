...
const QuestBoard: React.FC<QuestBoardProps> = ({ quests, dispatch }) => {
  ...
  return (
    <div className="bg-amber-100 dark:bg-gray-800 rounded-lg p-6 shadow-lg flex flex-col transition-colors h-full">
      ...
      <div className="mb-4">
        ...
        >
          ...
          {isLoading ? 'Generating...' : 'Generate New Quest'}
        </button>
      </div>
